...
export default function StepWelcome({ onNextPdf, onNextManual }) {
  return (
    <div className="flex-1 w-full flex flex-col p-6 sm:p-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full max-w-2xl">
          {/* Card 1: Start with PDF */}
          <button
            onClick={onNextPdf}
            className="group relative flex flex-row md:flex-col items-center md:items-start p-6 bg-white border-2 border-slate-200 rounded-2xl text-left hover:border-blue-500 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
          >
            <div className="bg-slate-800 text-white p-3 rounded-xl mr-4 md:mr-0 md:mb-6 shadow-lg shadow-slate-200 group-hover:bg-blue-600 transition-colors">
              <FileUp size={24} className="md:w-7 md:h-7" strokeWidth={2} />
            </div>
            <div className="flex-1">
              <h3 className="font-bold text-slate-800 text-lg sm:text-xl mb-1 group-hover:text-blue-950 transition-colors">Start with PDF</h3>
              <p className="text-slate-500 text-sm leading-snug">
                I have a resume, just tailor it for a new job.
              </p>
            </div>
            <ChevronRight className="md:hidden text-slate-400 group-hover:text-blue-600 transition-colors" />
          </button>
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="font-bold text-slate-800 text-lg sm:text-xl mb-1 group-hover:text-blue-950 transition-colors">Manual Input</h3>
              <p className="text-slate-500 text-sm leading-snug">
      ...
      {/* 3. The "How it Works" Footer */}
      {/* <div className="mt-10 pt-8 border-t border-blue-50/50">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="flex items-center gap-3 sm:flex-col sm:text-center">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold border border-blue-100">1</div>
            <div>
          ...
          <div className="flex items-center gap-3 sm:flex-col sm:text-center">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold border border-blue-100">2</div>
            <div>
          ...
          <div className="flex items-center gap-3 sm:flex-col sm:text-center">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 font-bold border border-blue-100">3</div>
            <div>
